...
function showNotification(e) {
  ...
  // notificationContainer.innerHTML = "CHRISTMAS SALE - <strong>20%</strong> OFF";
  notificationContainer.innerHTML =
    "EASTER SALE - <strong>15% OFF</strong> - use code <strong>15EASTER22</strong> at checkout";
  // notificationContainer.innerHTML = "BOXING DAY SALE - <strong>25%</strong> OFF";
  //notificationContainer.innerHTML = "FREE DELIVERY FOR ORDERS OVER <strong>$95</strong>";
}

function addCookieAlertContainer(e) {
  var cookieAlertContainer = document.getElementById("cookie-alert-container");
  cookieAlertContainer.innerHTML =
...
function showCatalogPageSalePrice(
  saleElementId,
  salePriceElementId,
  itemPrice
) {
  ...
  if (discountPercentage > 0) {
    showElement(saleElementId);
  } else {
    decimalPlaces = 0;
  }

  var salePriceElement = document.getElementById(salePriceElementId);
  var salePrice = calculateSalePrice(itemPrice);
  salePriceElement.innerHTML =
    '<h4 class="text-muted menu-price"><i class="fas fa-cart-plus"></i> $' +
    salePrice.toFixed(decimalPlaces) +
    "</h4>";
}

function showProductPageSalePrice(
  saleElementId,
  salePriceElementId,
  itemPrice
) {
  ...
  var salePrice = calculateSalePrice(itemPrice);
  salePriceElement.innerHTML =
    '<h3 class="special-dishes-price">$' +
    salePrice.toFixed(decimalPlaces) +
    "</h3>";
}

function calculateSalePrice(itemPrice) {
